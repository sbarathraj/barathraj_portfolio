...
const projects = [
  {
    id: 1,
    title: 'BarathAI',
    description: 'A modern AI chat platform with real-time messaging, admin dashboard, analytics, and secure login. Built with React, Tailwind CSS, and Supabase (PostgreSQL, REST API).',
   // image: 'https://images.pexels.com/photos/230544/pexels-photo-230544.jpeg',
    image: 'https://ik.imagekit.io/barthraj/BarathAI.jpg?updatedAt=1753026008287',
    tags: ['React', 'Tailwind CSS', 'Supabase', 'PostgreSQL', 'REST API', 'AI', 'Admin Dashboard'],
    demoUrl: 'https://barathai.web.app/',
    repoUrl: 'https://github.com/sbarathraj/barathai.git',
  },
  {
    id: 2,
    title: 'Portfolio',
    description: 'A visually engaging portfolio with 3D animations, smooth transitions, and responsive design. Built using React, Three.js, Framer Motion, and Tailwind CSS.',
    //image: 'https://images.pexels.com/photos/326503/pexels-photo-326503.jpeg',
    image: 'https://ik.imagekit.io/barthraj/Barath%20Portfolio.jpg?updatedAt=1753026008727',
    tags: ['React', 'Three.js', 'Framer Motion', 'Tailwind CSS', 'Vite', 'EmailJS'],
    demoUrl: 'https://barathraj.web.app/',
    repoUrl: 'https://github.com/sbarathraj/barathraj_portfolio.git',
  },
  {
    id: 3,
    title: 'DSA Tracker',
    description: 'A full-stack web app to track DSA progress with user auth, problem management, analytics, and badges. React frontend, Supabase backend, Firebase hosting.',
    image: 'https://images.pexels.com/photos/2004161/pexels-photo-2004161.jpeg',
    tags: ['React', 'Vite', 'Tailwind CSS', 'Supabase', 'PostgreSQL', 'Firebase', 'DSA'],
    demoUrl: 'https://dsatracker.web.app/',
    repoUrl: 'https://github.com/sbarathraj/DSA-Tracker.git',
  },
  {
    id: 4,
    title: 'EnglishAI',
    description: 'A serverless English learning app with chat, vocabulary, progress tracking, and AI features. React frontend connects directly to Supabase and third-party APIs.',
    image: 'https://images.pexels.com/photos/9783346/pexels-photo-9783346.jpeg',
    tags: ['React', 'TypeScript', 'Vite', 'Tailwind CSS', 'Supabase', 'PostgreSQL', 'OpenRouter AI', 'AssemblyAI', 'LibreTranslate'],
    demoUrl: 'https://barathraj.web.app/',
    repoUrl: 'https://github.com/sbarathraj/barathraj_portfolio.git',
  },
];
